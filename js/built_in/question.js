...
var date1 = day.getTime();
var date2 = new Date("2025/5/3");
console.log(`大阪万博まであと${Math.ceil((date2 - date1) / (1000 * 60 * 60 * 24))}日`);
